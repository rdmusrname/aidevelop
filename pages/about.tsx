        ...
        <Page title="About">
            <PrivacyPolicyContainer>
                <RichText>
                    ...
                    <p>We are excited to be on this journey and look forward to the many opportunities it will bring. We invite you to join us as we explore the future of AI and web development. For more information you can reach out to us using the contact page.</p>
                </RichText>
            </PrivacyPolicyContainer>
        </Page>
    );
